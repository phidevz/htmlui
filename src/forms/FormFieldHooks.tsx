...
const RequiredField: React.FC<{
    state: [string | undefined, React.Dispatch<SetStateAction<string | undefined>>, true | string],
    label: string,
    name: string,
    props: object,
    helpText: string | undefined
}> = ({ state, label, name, props = {}, helpText = undefined }) => {
...
const BooleanField: React.FC<{
    state: [boolean, React.Dispatch<SetStateAction<boolean>>, true | string],
    label: string,
    name: string,
    props: object,
    helpText: string | undefined
...
const OptionalField: React.FC<{
    state: [string | undefined, React.Dispatch<SetStateAction<string | undefined>>],
    label: string | undefined,
    name: string,
    props: object,
    helpText: string | undefined,
    invalidFeedback: string | undefined
}> = ({ state, label, name, props = {}, helpText = undefined, invalidFeedback = undefined }) => {
